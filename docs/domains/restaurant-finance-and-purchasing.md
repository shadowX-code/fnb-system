...
Product Analytics remains a separate authority: completed product-sales reports/items provide product ranking and the period's total product sales revenue only, never Financial Revenue. Rankings preserve category/product/variant identity; Top 10 is sales revenue descending, and Bottom 10 is ascending after excluding non-positive sales. Product sales mix uses that canonical product-sales total as its denominator. Missing or incomplete Product Analytics data does not block a financial report.
