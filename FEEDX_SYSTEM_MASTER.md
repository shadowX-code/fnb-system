...
| Factory | Active | Factory master data, production, warehouse, physical-cash Petty Cash, traceability, MeSTI Cleaning, Health Declaration, Operator Hygiene compliance, and reporting read models. |
