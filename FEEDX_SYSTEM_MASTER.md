...
| Reporting | In Development | Server-authoritative, outlet-scoped financial and product-performance read contracts are available; Admin poster UI and export are deferred. |
