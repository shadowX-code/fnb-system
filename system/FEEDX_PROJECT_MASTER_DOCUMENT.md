...
- Recipe Gross Profit Trend and Ingredient Consumption Trend are controlled by a Trend Year selector and always render Jan-Dec for that year. Missing months render as zero so operators can compare full-year seasonality. Analysis Period remains separate and controls the Menu Engineering Matrix, AI Insights context, and Ingredient Demand Forecast averaging.
