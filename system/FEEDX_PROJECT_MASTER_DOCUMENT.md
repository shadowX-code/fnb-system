...
- Ingredient Consumption Trend shows monthly estimated ingredient cost, not quantity. It defaults to the top five ingredients by total estimated cost for the selected year, allows searching ingredients, and allows selecting up to five ingredients for comparison.
