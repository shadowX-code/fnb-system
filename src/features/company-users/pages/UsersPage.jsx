...
const mockUsers = [
  {
    ...
    contact: "012-888 1200",
    ic_no: "880101-08-8888",
    gender: "Male",
    birthday: "1988-01-01",
    role: "owner",
    position: "Owner",
    workplace: "All Outlets",
    outlet_access: ["Hola Ipoh Bangsar", "Hola TTDI", "Hola Mont Kiara"],
    employment_status: "full_time",
    access_state: "active",
    enable_system_login: true,
    is_active: true,
    email_verified: true,
    last_login_at: "2026-05-12T09:42:00.000Z",
    joined_date: "2024-01-01",
    bank_name: "Maybank",
    bank_account_number: "5142 8801 2009",
    bank_account_name: "Marcus Lee",
    audit_summary: "Updated tax settings 2 days ago.",
  },
  {
    id: "user-2",
    full_name: "Amanda Tan",
    nickname: "Amanda",
    nationality: "Malaysia",
    email: "amanda@company.com",
    contact: "011-222 4588",
    ic_no: "920312-10-2244",
    gender: "Female",
    birthday: "1992-03-12",
    role: "manager",
    position: "Outlet Manager",
    workplace: "Hola Ipoh Bangsar",
    outlet_access: ["Hola Ipoh Bangsar"],
    employment_status: "full_time",
    access_state: "active",
    enable_system_login: true,
    is_active: true,
    email_verified: true,
    last_login_at: "2026-05-11T18:05:00.000Z",
    joined_date: "2024-04-15",
    bank_name: "CIMB",
    bank_account_number: "8601 2245 8802",
    bank_account_name: "Amanda Tan",
    audit_summary: "Saved sales data yesterday.",
  },
  {
    id: "user-3",
    full_name: "Jason Lim",
    ...
    contact: "016-908 3311",
    ic_no: "900808-14-7788",
    gender: "Male",
    birthday: "1990-08-08",
    role: "purchaser",
    position: "Purchaser",
    workplace: "Hola TTDI",
    outlet_access: ["Hola TTDI", "Hola Subang"],
    employment_status: "full_time",
    ...
    bank_account_number: "4312 9908 3311",
    bank_account_name: "Jason Lim",
    audit_summary: "Pending verification.",
  },
  {
    id: "user-4",
    full_name: "Nur Aina",
    ...
    contact: "018-774 2109",
    ic_no: "990711-10-1432",
    gender: "Female",
    birthday: "1999-07-11",
    role: "staff",
    position: "Cashier",
    workplace: "Hola Mont Kiara",
    outlet_access: ["Hola Mont Kiara"],
    ...
    bank_name: "",
    bank_account_number: "",
    bank_account_name: "Nur Aina",
    audit_summary: "No recent admin actions.",
  },
  {
    id: "user-5",
    full_name: "Lee Wen",
    nickname: "Wen",
    nationality: "Malaysia",
    email: "wen@company.com",
    contact: "013-557 0908",
    ic_no: "951201-08-1041",
    gender: "Female",
    birthday: "1995-12-01",
    role: "",
    position: "Legacy Helper",
    workplace: "",
    outlet_access: [],
    ...
    is_active: false,
    email_verified: true,
    last_login_at: "2026-03-01T08:10:00.000Z",
    joined_date: "2024-11-01",
    resigned_date: "2026-03-15",
    bank_name: "",
    bank_account_number: "",
    bank_account_name: "Lee Wen",
    audit_summary: "Marked resigned by HR.",
  },
];
  ...
  function handleSubmit() {
    ...
    window.setTimeout(() => {
      onSubmit({
        ...
        id: values.id || `user-${crypto.randomUUID()}`,
