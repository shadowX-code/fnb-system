...
export default function LegalEntitiesPage({ ui, auth }) {
  ...
  if (contractWorkspaceEntityId) {
    return <LegalEntityContractWorkspacePage
      ...
      auth={auth}
      ui={ui}
      onBack={() => { navigateAdminRoute("legal-entities"); }}
    />;
  }
