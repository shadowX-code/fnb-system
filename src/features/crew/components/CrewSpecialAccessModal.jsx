...
export default function CrewSpecialAccessModal({ employee, onClose, onSaved }) {
  ...
  async function save() {
    ...
    try {
      onSaved?.(await crewService.updateSpecialAccess(employee.id, { handover, addAssets, adjustAssets, inspectAssets, manageAssetDetails }));
      onClose();
    }
