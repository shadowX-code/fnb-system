...
export default function CrewSpecialAccessModal({ employee, onClose, onSaved }) {
  ...
  async function save() {
    ...
    try {
      onSaved?.(await crewService.updateSpecialAccess(employee.id, { handover, adjustAssets, inspectAssets }));
      onClose();
    }
