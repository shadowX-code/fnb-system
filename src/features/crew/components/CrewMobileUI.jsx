...
export function CrewSectionHeader({ title, action, onAction }) {
  return <div className="crew-ui-section-head"><h2>{title}</h2>{action && <button type="button" onClick={onAction}>{action}</button>}</div>;
}
