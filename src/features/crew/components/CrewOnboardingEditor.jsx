...
export default function CrewOnboardingEditor({ journey, outlet, sops, saving, confirm, onClose, onSave, onPublish }) {
  ...
  const hasPendingImage = draft.modules.some((module) => module.lessons.some((lesson) => lesson.blocks.some((block) => block.pending_image)));
...
function ContentBlockEditor({ block, index, count, sops, onChange, onMove, onDelete }) {
