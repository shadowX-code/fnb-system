...
export default function CrewLeaveMobile({ token, onBack, onChanged }) {
  ...
  return <section className="crew-leave-page">
    <CrewMobileDetailHeader title={t("leave.title")} onBack={onBack} action={<button type="button" className="crew-mobile-primary crew-leave-header-action" onClick={() => setStep(1)}><Plus size={16} /> {t("leave.apply")}</button>} />
