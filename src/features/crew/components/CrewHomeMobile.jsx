...
export default function CrewHomeMobile({ session, attendance, context, roster, operations, clock, navigate, onOpenTask, theme, onToggleTheme, notificationUnreadCount = 0 }) {
  const { t } = useTranslation();
