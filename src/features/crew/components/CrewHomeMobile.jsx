      ...
      <section className={`crew-home-attendance is-${attendanceMode}`} aria-label={t("locationEvidence.attendanceStatus")}>
        <div className="crew-home-attendance-main">
          ...
          <CrewHomeClockMotion attendanceMode={attendanceMode} transition={clockTransition} loading={loading} hasException={locationEvidence.tone === "is-exception"}>
            ...
            {attendanceMode !== "completed" && (locationEvidence.tone === "is-exception"
              ? <span className="crew-home-location-exception" title={locationEvidence.title}><MapPin size={13} /><span>{locationEvidence.label}</span></span>
              : <em className={`crew-home-gps ${locationEvidence.tone}`} title={locationEvidence.title}><ShieldCheck size={13} /><span>{locationEvidence.label}</span></em>)}
          </CrewHomeClockMotion>
        </div>
