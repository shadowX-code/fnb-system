...
describe("Crew login presentation", () => {
  it("uses the FeedX fallback when no verified outlet is available", () => {
  ...
  it("can present a verified outlet without changing the mobile sign-in flow", () => {
    render(<CrewLogin outletName="Hola Hola Kopitiam Ipoh" onSignedIn={() => {}} />);
    expect(screen.getByRole("heading", { name: /Welcome to Hola Hola Kopitiam Ipoh Crew/ })).not.toBeNull();
