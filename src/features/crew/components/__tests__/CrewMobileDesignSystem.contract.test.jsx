...
describe("Crew Mobile design system contract", () => {
  ...
  it("keeps Learn categories neutral except for the canonical active state", () => {
    ...
    expect(learningStyles).toContain("grid-template-columns:40px minmax(0,1fr) minmax(64px,92px) 24px");
    ...
    expect(learningStyles).toContain(".crew-learn-final-ack>.crew-ui-status{justify-self:end;max-width:100%;padding-inline:6px;white-space:normal");
  });
  ...
  it("gives Reward one token-based feature presentation owner", () => {
    ...
    expect(system).toContain(".crew-mobile-page-header-action>button:not(.crew-ui-help-trigger):not(.crew-mobile-primary)");
