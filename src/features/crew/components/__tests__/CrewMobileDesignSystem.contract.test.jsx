...
describe("Crew Mobile design system contract", () => {
  ...
  it("gives Reward one token-based feature presentation owner", () => {
    ...
    [".crew-reward-hero-metrics", ".crew-reward-editorial", ".crew-reward-performance-relationship", ".crew-reward-potential", ".crew-reward-modal-history"].forEach((selector) => expect(rewardStyles).toContain(selector));
