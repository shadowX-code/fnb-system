...
export default function CrewMobileApp() {
  ...
  return <main className="crew-v2-shell"><section className="crew-v2-app">
    {screen === "home" && <section className="crew-v2-home">
      ...
      <section className="crew-v2-home-section crew-home-tasks"><CrewSectionHeader title={t("home.todaysTasks")} meta={homeTasks.length} action={t("common.viewAll")} actionLabel={t("tasks.title")} onAction={() => { setOperationTarget(null); setScreen("operations"); }} /><div className="crew-home-list">
