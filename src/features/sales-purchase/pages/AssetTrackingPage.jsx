            ...
            <div className="space-y-5">
              <div className="grid gap-3 md:grid-cols-2">
                <div className="rounded-3xl border border-primary/15 bg-primary/5 p-5">
                  ...
                  <div className="mt-2 text-primary-type-kpi-value text-text-primary">{asset.current_quantity} <span className="text-base font-black text-text-muted">{asset.unit}</span></div>
...
function collectAssetActorIds({ assets = [], movements = [], inspections = [], maintenanceRecords = [] }) {
  ...
  assets.forEach((asset) => {
    ...
    add(asset.created_by_employee_id);
