  ...
  return (
    <div className="space-y-5">
      <PageHeader
        section="Controls"
        title="Data Import"
        description="Prepare Excel and CSV import workflows for sales and supplier purchase records."
        actions={<button className="btn-secondary" onClick={() => ui.notify({ title: "Template downloaded", message: "Mock template action completed." })}><Download size={16} /> Template</button>}
      />
