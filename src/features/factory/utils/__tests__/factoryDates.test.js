...
import { formatDateDisplay, formatFactoryListDate, formatFactoryListDateTime, formatFactoryListTime, factoryMonthLabel } from "../factoryDates.js";
...
describe("Factory list date formatting", () => {
  ...
  it("separates the Factory list date and local time hierarchy", () => {
    ...
    expect(formatFactoryListTime("2026-09-05T10:42:00+08:00")).toBe("10:42 AM");
    expect(factoryMonthLabel("2026-09")).toBe("September 2026");
  });
});
