...
export default function FactoryProductRecipesPage() {
  ...
  return <div className="space-y-5">
    ...
    {editorRecipe !== null ? <ProductRecipeModal initialValue={editorRecipe} productFamilies={productFamilies} finishedGoods={finishedGoods} rawMaterials={rawMaterials} receivings={receivings} onClose={() => setEditorRecipe(null)} onSave={async (form) => { await actions.saveProductRecipe(form); setEditorRecipe(null); }} /> : null}
