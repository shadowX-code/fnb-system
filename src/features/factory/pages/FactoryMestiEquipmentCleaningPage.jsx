...
export default function FactoryMestiEquipmentCleaningPage({ onNotify }) {
  ...
  function occurrenceActions(row) {
    ...
    return {
      canComplete,
      canVerify: canReview,
      onComplete: () => act("complete", row),
      onVerify: () => act("verify", row, "verified"),
      onMarkUnsatisfactory: canReview ? () => act("verify", row, "unsatisfactory") : undefined,
    };
  }
