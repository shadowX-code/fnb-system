...
export function FactoryNavigationProvider({ auditReferenceLoading, openAuditReference, rawMovementReferenceLoading, openRawMaterialMovementReference, openingBatchTraceabilityDispatchId, openBatchTraceabilityDispatch, openCreateSupplier, openEditSupplier, archiveSupplier, openCreateCustomer, openEditCustomer, archiveCustomer, openCreateStorageLocation, openEditStorageLocation, archiveStorageLocation, openCreateFinishedGood, openEditFinishedGood, archiveFinishedGood, openFinishedGoodPackagingSku, archiveFinishedGoodPackagingSku, openFinishedGoodCategory, openCreateRawMaterial, openEditRawMaterial, openRawMaterialCost, openRawMaterialImage, openRawMaterialCategory, openPlanningJobOrderDraft, openProductionPlanningPar, children }) {
  const value = useMemo(
