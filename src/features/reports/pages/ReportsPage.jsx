...
export default function ReportsPage({ store, ui, auth }) {
  ...
  async function download(format) {
    ...
    setExporting(format);
    try {
      const filename = await exportPoster({ element: posterRef.current, reportType: generated.reportType, dataset: generated.dataset, filters: generated.filters, format });
  ...
  return <div className="space-y-5">
    ...
    {generated ? <section className="space-y-4">
      ...
      <div className="rounded-3xl border border-border bg-slate-100/80 p-3 sm:p-6"><div ref={posterRef} className="mx-auto w-full max-w-[760px]">{generated.reportType === "monthly" ? <MonthlyProfitPoster dataset={generated.dataset} /> : <YearlyPnlPoster dataset={generated.dataset} />}</div></div>
