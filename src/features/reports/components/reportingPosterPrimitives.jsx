...
export function MetricValue({label,metric,className=""}){return <div className={className}><span className="poster-metric-label">{label}</span><strong className="poster-value">{metric}</strong></div>;}
