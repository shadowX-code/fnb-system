-- Presentation-only category names from canonical item/category relationships.
-- Opaque Crew scope, PO lifecycle and all existing read fields remain unchanged.
