-- Keep the Part A bonus threshold specific to Malaysian employees below 60.
-- Part E remains on its own 0%/4% schedule even when bonus classification is
-- not needed. Unknown category stays explicitly Review Required.
