-- Update raw material stock check reference format to RMSC-YYMMDD-01.
-- Replaces only the creation RPC; no schema or stock adjustment logic changes.
...
begin
  ...
  v_check_no := 'RMSC-' || v_yymmdd || '-' || lpad(v_next::text, 2, '0');
