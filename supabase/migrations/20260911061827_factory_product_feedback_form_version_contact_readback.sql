-- Keep the existing analytics read authority intact while restoring the
-- contact evidence projection added before form versions existed.
alter function public.factory_product_feedback_admin_data(uuid)
  rename to factory_product_feedback_admin_data_base;

create function public.factory_product_feedback_admin_data(p_campaign_id uuid default null)
