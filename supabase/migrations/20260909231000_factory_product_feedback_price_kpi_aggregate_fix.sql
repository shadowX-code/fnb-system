-- Price options belong to a question and share one canonical currency. Aggregate that
-- currency before building the role-driven price KPI so the Admin read model remains valid.
